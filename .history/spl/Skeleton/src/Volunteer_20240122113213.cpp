...
// constructor
Volunteer :: Volunteer(int id, const string &name) : id(id) , name(name) , completedOrderId(NO_ORDER) , activeOrderId(NO_ORDER) , orderPointer(nullptr){}

Volunteer :: Volunteer(const Volunteer &other) : id(other.getId()) , name(other.getName()) ,completedOrderId(other.getCompletedOrderId()) , activeOrderId(other.getActiveOrderId()), orderPointer(other.getOrderPointer()){}
// getters:
...
int LimitedCollectorVolunteer::  WhoAmI() const{
 ...
 // DriverVolunteer Class Implementation
    ...
    DriverVolunteer :: DriverVolunteer(const DriverVolunteer &other) : Volunteer(other), maxDistance(other.maxDistance),distancePerStep(other.distancePerStep),distanceLeft(other.maxDistance) {}
